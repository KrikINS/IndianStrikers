...
import { X, Download, FileText, Image as ImageIcon, Share2, Target, Zap, Trophy, MapPin, Calendar, ExternalLink, ChevronRight, Activity, Award, RotateCw, Clock } from 'lucide-react';
    ...
    return (
        <div ref={modalContentRef} id="scorecard-capture-target" className="fixed inset-0 z-[150] bg-slate-950 flex flex-col overflow-hidden">
            <div className="sticky top-0 z-[160] bg-slate-950/90 backdrop-blur-xl border-b border-white/10 p-4">
                ...
                <div className="max-w-7xl mx-auto flex gap-6 mt-4 border-b border-white/5 px-4 sm:px-0">
            ...
            <div className={`flex-1 overflow-y-auto p-4 ${activeTab === 'scorecard' ? 'bg-white' : 'bg-slate-50'}`}>
                {activeTab === 'commentary' && (
                    <div className="max-w-7xl mx-auto mb-6 flex items-center justify-between bg-white px-6 py-3 rounded-2xl border border-slate-200 shadow-sm">
                        <div className="flex items-center gap-3">
                        ...
                        <button 
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-sky-50 hover:bg-sky-100 text-sky-600 rounded-xl transition-all active:scale-95"
                        >
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className="text-sm text-slate-800 leading-relaxed">
                                                                            {ball.zone && ball.zone !== 'Unknown' && (
                                                                                <span className="inline-block px-1.5 py-0.5 bg-slate-100 border border-slate-200 text-[10px] font-bold text-slate-500 rounded mr-2 uppercase tracking-tighter">
                                                                                    {ball.zone}
                                                                                </span>
                                                                            )}
                                                                            {ball.commentary || ball.ballLog || `${ball.runs} runs.`}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                {ball.isWicket && (
